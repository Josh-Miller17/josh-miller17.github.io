...
```{r}
#| size: "scriptsize"
html <- read_html("KimchiGrilledCheese.html") # loaded the html and saved it as an object called html
```
...
Solution:
I did not use any conditionals in my code for the menu. I could have used a conditional statement when making my total ingredients list on the first page of the menu. I could have made it so if an ingredient was already on the list, I could code it to not add it again.
